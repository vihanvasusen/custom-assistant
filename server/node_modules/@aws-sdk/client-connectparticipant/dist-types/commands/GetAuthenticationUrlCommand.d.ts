...
declare const GetAuthenticationUrlCommand_base: {
    new (input: GetAuthenticationUrlCommandInput): import("@smithy/smithy-client").CommandImpl<GetAuthenticationUrlCommandInput, GetAuthenticationUrlCommandOutput, ConnectParticipantClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetAuthenticationUrlCommandInput): import("@smithy/smithy-client").CommandImpl<GetAuthenticationUrlCommandInput, GetAuthenticationUrlCommandOutput, ConnectParticipantClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
