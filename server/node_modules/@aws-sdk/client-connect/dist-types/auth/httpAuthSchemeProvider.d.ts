 ...
 * @internal
 */
export interface ConnectHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<ConnectClientResolvedConfig, HandlerExecutionContext, ConnectHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultConnectHttpAuthSchemeParametersProvider: (config: ConnectClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<ConnectHttpAuthSchemeParameters>;
/**
 * @internal
 */
