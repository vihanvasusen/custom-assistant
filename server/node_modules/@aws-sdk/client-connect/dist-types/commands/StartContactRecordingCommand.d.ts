...
declare const StartContactRecordingCommand_base: {
    new (input: StartContactRecordingCommandInput): import("@smithy/smithy-client").CommandImpl<StartContactRecordingCommandInput, StartContactRecordingCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartContactRecordingCommandInput): import("@smithy/smithy-client").CommandImpl<StartContactRecordingCommandInput, StartContactRecordingCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartContactRecordingCommand extends StartContactRecordingCommand_base {
