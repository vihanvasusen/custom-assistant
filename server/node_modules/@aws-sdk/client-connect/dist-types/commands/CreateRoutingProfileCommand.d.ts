...
declare const CreateRoutingProfileCommand_base: {
    new (input: CreateRoutingProfileCommandInput): import("@smithy/smithy-client").CommandImpl<CreateRoutingProfileCommandInput, CreateRoutingProfileCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateRoutingProfileCommandInput): import("@smithy/smithy-client").CommandImpl<CreateRoutingProfileCommandInput, CreateRoutingProfileCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
