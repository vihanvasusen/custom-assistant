...
declare const ListQueueQuickConnectsCommand_base: {
    new (input: ListQueueQuickConnectsCommandInput): import("@smithy/smithy-client").CommandImpl<ListQueueQuickConnectsCommandInput, ListQueueQuickConnectsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListQueueQuickConnectsCommandInput): import("@smithy/smithy-client").CommandImpl<ListQueueQuickConnectsCommandInput, ListQueueQuickConnectsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListQueueQuickConnectsCommand extends ListQueueQuickConnectsCommand_base {
