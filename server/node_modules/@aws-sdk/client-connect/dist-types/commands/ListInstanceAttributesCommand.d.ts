...
declare const ListInstanceAttributesCommand_base: {
    new (input: ListInstanceAttributesCommandInput): import("@smithy/smithy-client").CommandImpl<ListInstanceAttributesCommandInput, ListInstanceAttributesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListInstanceAttributesCommandInput): import("@smithy/smithy-client").CommandImpl<ListInstanceAttributesCommandInput, ListInstanceAttributesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
