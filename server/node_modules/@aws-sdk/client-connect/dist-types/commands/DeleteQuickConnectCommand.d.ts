...
declare const DeleteQuickConnectCommand_base: {
    new (input: DeleteQuickConnectCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteQuickConnectCommandInput, DeleteQuickConnectCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteQuickConnectCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteQuickConnectCommandInput, DeleteQuickConnectCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
