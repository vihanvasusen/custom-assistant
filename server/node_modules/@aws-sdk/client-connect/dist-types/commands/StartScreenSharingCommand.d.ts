...
declare const StartScreenSharingCommand_base: {
    new (input: StartScreenSharingCommandInput): import("@smithy/smithy-client").CommandImpl<StartScreenSharingCommandInput, StartScreenSharingCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartScreenSharingCommandInput): import("@smithy/smithy-client").CommandImpl<StartScreenSharingCommandInput, StartScreenSharingCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
