...
declare const DeleteSecurityProfileCommand_base: {
    new (input: DeleteSecurityProfileCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteSecurityProfileCommandInput, DeleteSecurityProfileCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteSecurityProfileCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteSecurityProfileCommandInput, DeleteSecurityProfileCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
