...
declare const CreateInstanceCommand_base: {
    new (input: CreateInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<CreateInstanceCommandInput, CreateInstanceCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<CreateInstanceCommandInput, CreateInstanceCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
