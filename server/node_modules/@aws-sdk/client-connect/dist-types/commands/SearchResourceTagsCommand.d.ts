...
declare const SearchResourceTagsCommand_base: {
    new (input: SearchResourceTagsCommandInput): import("@smithy/smithy-client").CommandImpl<SearchResourceTagsCommandInput, SearchResourceTagsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SearchResourceTagsCommandInput): import("@smithy/smithy-client").CommandImpl<SearchResourceTagsCommandInput, SearchResourceTagsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class SearchResourceTagsCommand extends SearchResourceTagsCommand_base {
