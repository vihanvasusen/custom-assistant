...
declare const SearchVocabulariesCommand_base: {
    new (input: SearchVocabulariesCommandInput): import("@smithy/smithy-client").CommandImpl<SearchVocabulariesCommandInput, SearchVocabulariesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SearchVocabulariesCommandInput): import("@smithy/smithy-client").CommandImpl<SearchVocabulariesCommandInput, SearchVocabulariesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class SearchVocabulariesCommand extends SearchVocabulariesCommand_base {
