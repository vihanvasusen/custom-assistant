...
declare const GetFlowAssociationCommand_base: {
    new (input: GetFlowAssociationCommandInput): import("@smithy/smithy-client").CommandImpl<GetFlowAssociationCommandInput, GetFlowAssociationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetFlowAssociationCommandInput): import("@smithy/smithy-client").CommandImpl<GetFlowAssociationCommandInput, GetFlowAssociationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetFlowAssociationCommand extends GetFlowAssociationCommand_base {
