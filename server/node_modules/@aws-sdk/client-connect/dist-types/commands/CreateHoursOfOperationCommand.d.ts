...
declare const CreateHoursOfOperationCommand_base: {
    new (input: CreateHoursOfOperationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateHoursOfOperationCommandInput, CreateHoursOfOperationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateHoursOfOperationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateHoursOfOperationCommandInput, CreateHoursOfOperationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
