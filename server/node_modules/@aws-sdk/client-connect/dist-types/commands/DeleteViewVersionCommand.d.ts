...
declare const DeleteViewVersionCommand_base: {
    new (input: DeleteViewVersionCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteViewVersionCommandInput, DeleteViewVersionCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteViewVersionCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteViewVersionCommandInput, DeleteViewVersionCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
