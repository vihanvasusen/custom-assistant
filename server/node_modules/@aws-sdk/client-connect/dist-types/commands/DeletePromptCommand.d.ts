...
declare const DeletePromptCommand_base: {
    new (input: DeletePromptCommandInput): import("@smithy/smithy-client").CommandImpl<DeletePromptCommandInput, DeletePromptCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeletePromptCommandInput): import("@smithy/smithy-client").CommandImpl<DeletePromptCommandInput, DeletePromptCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
