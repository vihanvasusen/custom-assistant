...
declare const SendChatIntegrationEventCommand_base: {
    new (input: SendChatIntegrationEventCommandInput): import("@smithy/smithy-client").CommandImpl<SendChatIntegrationEventCommandInput, SendChatIntegrationEventCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SendChatIntegrationEventCommandInput): import("@smithy/smithy-client").CommandImpl<SendChatIntegrationEventCommandInput, SendChatIntegrationEventCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class SendChatIntegrationEventCommand extends SendChatIntegrationEventCommand_base {
