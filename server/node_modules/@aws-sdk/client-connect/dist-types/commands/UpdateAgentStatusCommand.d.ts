...
declare const UpdateAgentStatusCommand_base: {
    new (input: UpdateAgentStatusCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAgentStatusCommandInput, UpdateAgentStatusCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateAgentStatusCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAgentStatusCommandInput, UpdateAgentStatusCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
