...
declare const ListEvaluationFormVersionsCommand_base: {
    new (input: ListEvaluationFormVersionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListEvaluationFormVersionsCommandInput, ListEvaluationFormVersionsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListEvaluationFormVersionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListEvaluationFormVersionsCommandInput, ListEvaluationFormVersionsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
