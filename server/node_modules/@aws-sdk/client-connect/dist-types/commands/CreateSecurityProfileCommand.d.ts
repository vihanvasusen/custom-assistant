...
declare const CreateSecurityProfileCommand_base: {
    new (input: CreateSecurityProfileCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSecurityProfileCommandInput, CreateSecurityProfileCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateSecurityProfileCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSecurityProfileCommandInput, CreateSecurityProfileCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
