...
declare const UpdateViewContentCommand_base: {
    new (input: UpdateViewContentCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateViewContentCommandInput, UpdateViewContentCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateViewContentCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateViewContentCommandInput, UpdateViewContentCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
