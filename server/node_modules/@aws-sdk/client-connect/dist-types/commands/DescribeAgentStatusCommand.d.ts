...
declare const DescribeAgentStatusCommand_base: {
    new (input: DescribeAgentStatusCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAgentStatusCommandInput, DescribeAgentStatusCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeAgentStatusCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAgentStatusCommandInput, DescribeAgentStatusCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
