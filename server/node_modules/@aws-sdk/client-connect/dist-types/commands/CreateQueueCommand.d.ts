...
declare const CreateQueueCommand_base: {
    new (input: CreateQueueCommandInput): import("@smithy/smithy-client").CommandImpl<CreateQueueCommandInput, CreateQueueCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateQueueCommandInput): import("@smithy/smithy-client").CommandImpl<CreateQueueCommandInput, CreateQueueCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
