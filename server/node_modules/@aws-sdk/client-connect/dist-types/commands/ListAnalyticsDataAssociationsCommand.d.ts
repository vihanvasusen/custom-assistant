...
declare const ListAnalyticsDataAssociationsCommand_base: {
    new (input: ListAnalyticsDataAssociationsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAnalyticsDataAssociationsCommandInput, ListAnalyticsDataAssociationsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListAnalyticsDataAssociationsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAnalyticsDataAssociationsCommandInput, ListAnalyticsDataAssociationsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListAnalyticsDataAssociationsCommand extends ListAnalyticsDataAssociationsCommand_base {
