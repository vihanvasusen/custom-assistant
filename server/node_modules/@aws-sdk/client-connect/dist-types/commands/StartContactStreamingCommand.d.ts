...
declare const StartContactStreamingCommand_base: {
    new (input: StartContactStreamingCommandInput): import("@smithy/smithy-client").CommandImpl<StartContactStreamingCommandInput, StartContactStreamingCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartContactStreamingCommandInput): import("@smithy/smithy-client").CommandImpl<StartContactStreamingCommandInput, StartContactStreamingCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartContactStreamingCommand extends StartContactStreamingCommand_base {
