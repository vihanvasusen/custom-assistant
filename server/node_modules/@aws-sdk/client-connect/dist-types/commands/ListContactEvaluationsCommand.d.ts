...
declare const ListContactEvaluationsCommand_base: {
    new (input: ListContactEvaluationsCommandInput): import("@smithy/smithy-client").CommandImpl<ListContactEvaluationsCommandInput, ListContactEvaluationsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListContactEvaluationsCommandInput): import("@smithy/smithy-client").CommandImpl<ListContactEvaluationsCommandInput, ListContactEvaluationsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListContactEvaluationsCommand extends ListContactEvaluationsCommand_base {
