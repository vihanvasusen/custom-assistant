...
declare const UpdateUserSecurityProfilesCommand_base: {
    new (input: UpdateUserSecurityProfilesCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUserSecurityProfilesCommandInput, UpdateUserSecurityProfilesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateUserSecurityProfilesCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUserSecurityProfilesCommandInput, UpdateUserSecurityProfilesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
