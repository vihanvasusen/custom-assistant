...
declare const CreatePredefinedAttributeCommand_base: {
    new (input: CreatePredefinedAttributeCommandInput): import("@smithy/smithy-client").CommandImpl<CreatePredefinedAttributeCommandInput, CreatePredefinedAttributeCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreatePredefinedAttributeCommandInput): import("@smithy/smithy-client").CommandImpl<CreatePredefinedAttributeCommandInput, CreatePredefinedAttributeCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
