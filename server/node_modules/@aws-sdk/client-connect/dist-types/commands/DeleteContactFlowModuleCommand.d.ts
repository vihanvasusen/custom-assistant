...
declare const DeleteContactFlowModuleCommand_base: {
    new (input: DeleteContactFlowModuleCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteContactFlowModuleCommandInput, DeleteContactFlowModuleCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteContactFlowModuleCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteContactFlowModuleCommandInput, DeleteContactFlowModuleCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
