...
declare const DeleteEvaluationFormCommand_base: {
    new (input: DeleteEvaluationFormCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteEvaluationFormCommandInput, DeleteEvaluationFormCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteEvaluationFormCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteEvaluationFormCommandInput, DeleteEvaluationFormCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
