...
declare const UpdateUserHierarchyStructureCommand_base: {
    new (input: UpdateUserHierarchyStructureCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUserHierarchyStructureCommandInput, UpdateUserHierarchyStructureCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateUserHierarchyStructureCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUserHierarchyStructureCommandInput, UpdateUserHierarchyStructureCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
