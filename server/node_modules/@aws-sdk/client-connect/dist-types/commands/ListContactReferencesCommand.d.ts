...
declare const ListContactReferencesCommand_base: {
    new (input: ListContactReferencesCommandInput): import("@smithy/smithy-client").CommandImpl<ListContactReferencesCommandInput, ListContactReferencesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListContactReferencesCommandInput): import("@smithy/smithy-client").CommandImpl<ListContactReferencesCommandInput, ListContactReferencesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
