...
declare const ListLexBotsCommand_base: {
    new (input: ListLexBotsCommandInput): import("@smithy/smithy-client").CommandImpl<ListLexBotsCommandInput, ListLexBotsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListLexBotsCommandInput): import("@smithy/smithy-client").CommandImpl<ListLexBotsCommandInput, ListLexBotsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListLexBotsCommand extends ListLexBotsCommand_base {
