...
declare const DeleteVocabularyCommand_base: {
    new (input: DeleteVocabularyCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVocabularyCommandInput, DeleteVocabularyCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteVocabularyCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVocabularyCommandInput, DeleteVocabularyCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
