...
declare const UpdateTaskTemplateCommand_base: {
    new (input: UpdateTaskTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateTaskTemplateCommandInput, UpdateTaskTemplateCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateTaskTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateTaskTemplateCommandInput, UpdateTaskTemplateCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
