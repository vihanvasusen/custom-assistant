...
declare const SubmitContactEvaluationCommand_base: {
    new (input: SubmitContactEvaluationCommandInput): import("@smithy/smithy-client").CommandImpl<SubmitContactEvaluationCommandInput, SubmitContactEvaluationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SubmitContactEvaluationCommandInput): import("@smithy/smithy-client").CommandImpl<SubmitContactEvaluationCommandInput, SubmitContactEvaluationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class SubmitContactEvaluationCommand extends SubmitContactEvaluationCommand_base {
