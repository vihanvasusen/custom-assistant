...
declare const DeleteHoursOfOperationCommand_base: {
    new (input: DeleteHoursOfOperationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteHoursOfOperationCommandInput, DeleteHoursOfOperationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteHoursOfOperationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteHoursOfOperationCommandInput, DeleteHoursOfOperationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
