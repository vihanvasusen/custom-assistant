...
declare const DeletePredefinedAttributeCommand_base: {
    new (input: DeletePredefinedAttributeCommandInput): import("@smithy/smithy-client").CommandImpl<DeletePredefinedAttributeCommandInput, DeletePredefinedAttributeCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeletePredefinedAttributeCommandInput): import("@smithy/smithy-client").CommandImpl<DeletePredefinedAttributeCommandInput, DeletePredefinedAttributeCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
