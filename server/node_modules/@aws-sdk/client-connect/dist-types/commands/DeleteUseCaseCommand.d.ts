...
declare const DeleteUseCaseCommand_base: {
    new (input: DeleteUseCaseCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteUseCaseCommandInput, DeleteUseCaseCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteUseCaseCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteUseCaseCommandInput, DeleteUseCaseCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
