...
declare const ListInstanceStorageConfigsCommand_base: {
    new (input: ListInstanceStorageConfigsCommandInput): import("@smithy/smithy-client").CommandImpl<ListInstanceStorageConfigsCommandInput, ListInstanceStorageConfigsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListInstanceStorageConfigsCommandInput): import("@smithy/smithy-client").CommandImpl<ListInstanceStorageConfigsCommandInput, ListInstanceStorageConfigsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
