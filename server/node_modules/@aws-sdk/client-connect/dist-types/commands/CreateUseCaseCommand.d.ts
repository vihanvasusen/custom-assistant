...
declare const CreateUseCaseCommand_base: {
    new (input: CreateUseCaseCommandInput): import("@smithy/smithy-client").CommandImpl<CreateUseCaseCommandInput, CreateUseCaseCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateUseCaseCommandInput): import("@smithy/smithy-client").CommandImpl<CreateUseCaseCommandInput, CreateUseCaseCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
