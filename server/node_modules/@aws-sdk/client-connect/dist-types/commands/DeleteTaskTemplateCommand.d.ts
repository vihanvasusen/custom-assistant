...
declare const DeleteTaskTemplateCommand_base: {
    new (input: DeleteTaskTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteTaskTemplateCommandInput, DeleteTaskTemplateCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteTaskTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteTaskTemplateCommandInput, DeleteTaskTemplateCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
