...
declare const UpdateUserRoutingProfileCommand_base: {
    new (input: UpdateUserRoutingProfileCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUserRoutingProfileCommandInput, UpdateUserRoutingProfileCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateUserRoutingProfileCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUserRoutingProfileCommandInput, UpdateUserRoutingProfileCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
