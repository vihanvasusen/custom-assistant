...
declare const ListQuickConnectsCommand_base: {
    new (input: ListQuickConnectsCommandInput): import("@smithy/smithy-client").CommandImpl<ListQuickConnectsCommandInput, ListQuickConnectsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListQuickConnectsCommandInput): import("@smithy/smithy-client").CommandImpl<ListQuickConnectsCommandInput, ListQuickConnectsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListQuickConnectsCommand extends ListQuickConnectsCommand_base {
