...
declare const ListContactFlowModulesCommand_base: {
    new (input: ListContactFlowModulesCommandInput): import("@smithy/smithy-client").CommandImpl<ListContactFlowModulesCommandInput, ListContactFlowModulesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListContactFlowModulesCommandInput): import("@smithy/smithy-client").CommandImpl<ListContactFlowModulesCommandInput, ListContactFlowModulesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
