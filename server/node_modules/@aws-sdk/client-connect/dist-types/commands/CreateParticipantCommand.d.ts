...
declare const CreateParticipantCommand_base: {
    new (input: CreateParticipantCommandInput): import("@smithy/smithy-client").CommandImpl<CreateParticipantCommandInput, CreateParticipantCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateParticipantCommandInput): import("@smithy/smithy-client").CommandImpl<CreateParticipantCommandInput, CreateParticipantCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
