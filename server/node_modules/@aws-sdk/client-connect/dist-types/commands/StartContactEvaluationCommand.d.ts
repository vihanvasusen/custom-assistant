...
declare const StartContactEvaluationCommand_base: {
    new (input: StartContactEvaluationCommandInput): import("@smithy/smithy-client").CommandImpl<StartContactEvaluationCommandInput, StartContactEvaluationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartContactEvaluationCommandInput): import("@smithy/smithy-client").CommandImpl<StartContactEvaluationCommandInput, StartContactEvaluationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartContactEvaluationCommand extends StartContactEvaluationCommand_base {
