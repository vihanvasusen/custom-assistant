...
declare const StopContactStreamingCommand_base: {
    new (input: StopContactStreamingCommandInput): import("@smithy/smithy-client").CommandImpl<StopContactStreamingCommandInput, StopContactStreamingCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StopContactStreamingCommandInput): import("@smithy/smithy-client").CommandImpl<StopContactStreamingCommandInput, StopContactStreamingCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StopContactStreamingCommand extends StopContactStreamingCommand_base {
