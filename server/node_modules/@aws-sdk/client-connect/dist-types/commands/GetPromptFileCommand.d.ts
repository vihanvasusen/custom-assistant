...
declare const GetPromptFileCommand_base: {
    new (input: GetPromptFileCommandInput): import("@smithy/smithy-client").CommandImpl<GetPromptFileCommandInput, GetPromptFileCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetPromptFileCommandInput): import("@smithy/smithy-client").CommandImpl<GetPromptFileCommandInput, GetPromptFileCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetPromptFileCommand extends GetPromptFileCommand_base {
