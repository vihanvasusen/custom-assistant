...
declare const StopContactRecordingCommand_base: {
    new (input: StopContactRecordingCommandInput): import("@smithy/smithy-client").CommandImpl<StopContactRecordingCommandInput, StopContactRecordingCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StopContactRecordingCommandInput): import("@smithy/smithy-client").CommandImpl<StopContactRecordingCommandInput, StopContactRecordingCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StopContactRecordingCommand extends StopContactRecordingCommand_base {
