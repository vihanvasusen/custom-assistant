...
declare const GetTrafficDistributionCommand_base: {
    new (input: GetTrafficDistributionCommandInput): import("@smithy/smithy-client").CommandImpl<GetTrafficDistributionCommandInput, GetTrafficDistributionCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetTrafficDistributionCommandInput): import("@smithy/smithy-client").CommandImpl<GetTrafficDistributionCommandInput, GetTrafficDistributionCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetTrafficDistributionCommand extends GetTrafficDistributionCommand_base {
