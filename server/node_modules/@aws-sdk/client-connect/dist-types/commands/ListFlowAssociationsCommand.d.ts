...
declare const ListFlowAssociationsCommand_base: {
    new (input: ListFlowAssociationsCommandInput): import("@smithy/smithy-client").CommandImpl<ListFlowAssociationsCommandInput, ListFlowAssociationsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListFlowAssociationsCommandInput): import("@smithy/smithy-client").CommandImpl<ListFlowAssociationsCommandInput, ListFlowAssociationsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
