...
declare const UpdateSecurityProfileCommand_base: {
    new (input: UpdateSecurityProfileCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSecurityProfileCommandInput, UpdateSecurityProfileCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateSecurityProfileCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSecurityProfileCommandInput, UpdateSecurityProfileCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
