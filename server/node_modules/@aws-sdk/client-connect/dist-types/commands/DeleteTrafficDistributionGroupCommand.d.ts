...
declare const DeleteTrafficDistributionGroupCommand_base: {
    new (input: DeleteTrafficDistributionGroupCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteTrafficDistributionGroupCommandInput, DeleteTrafficDistributionGroupCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteTrafficDistributionGroupCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteTrafficDistributionGroupCommandInput, DeleteTrafficDistributionGroupCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
