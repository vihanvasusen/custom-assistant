...
declare const DeleteIntegrationAssociationCommand_base: {
    new (input: DeleteIntegrationAssociationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteIntegrationAssociationCommandInput, DeleteIntegrationAssociationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteIntegrationAssociationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteIntegrationAssociationCommandInput, DeleteIntegrationAssociationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
