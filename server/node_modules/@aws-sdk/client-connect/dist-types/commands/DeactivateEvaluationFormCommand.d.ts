...
declare const DeactivateEvaluationFormCommand_base: {
    new (input: DeactivateEvaluationFormCommandInput): import("@smithy/smithy-client").CommandImpl<DeactivateEvaluationFormCommandInput, DeactivateEvaluationFormCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeactivateEvaluationFormCommandInput): import("@smithy/smithy-client").CommandImpl<DeactivateEvaluationFormCommandInput, DeactivateEvaluationFormCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
