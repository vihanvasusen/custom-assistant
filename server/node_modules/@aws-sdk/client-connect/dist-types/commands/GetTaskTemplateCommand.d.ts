...
declare const GetTaskTemplateCommand_base: {
    new (input: GetTaskTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<GetTaskTemplateCommandInput, GetTaskTemplateCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetTaskTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<GetTaskTemplateCommandInput, GetTaskTemplateCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetTaskTemplateCommand extends GetTaskTemplateCommand_base {
