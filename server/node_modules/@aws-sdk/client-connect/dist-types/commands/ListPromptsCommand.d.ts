...
declare const ListPromptsCommand_base: {
    new (input: ListPromptsCommandInput): import("@smithy/smithy-client").CommandImpl<ListPromptsCommandInput, ListPromptsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListPromptsCommandInput): import("@smithy/smithy-client").CommandImpl<ListPromptsCommandInput, ListPromptsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListPromptsCommand extends ListPromptsCommand_base {
