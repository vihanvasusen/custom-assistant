...
declare const CreateIntegrationAssociationCommand_base: {
    new (input: CreateIntegrationAssociationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateIntegrationAssociationCommandInput, CreateIntegrationAssociationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateIntegrationAssociationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateIntegrationAssociationCommandInput, CreateIntegrationAssociationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
