...
declare const ListDefaultVocabulariesCommand_base: {
    new (input: ListDefaultVocabulariesCommandInput): import("@smithy/smithy-client").CommandImpl<ListDefaultVocabulariesCommandInput, ListDefaultVocabulariesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListDefaultVocabulariesCommandInput): import("@smithy/smithy-client").CommandImpl<ListDefaultVocabulariesCommandInput, ListDefaultVocabulariesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
