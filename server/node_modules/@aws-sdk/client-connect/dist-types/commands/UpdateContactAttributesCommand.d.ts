...
declare const UpdateContactAttributesCommand_base: {
    new (input: UpdateContactAttributesCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateContactAttributesCommandInput, UpdateContactAttributesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateContactAttributesCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateContactAttributesCommandInput, UpdateContactAttributesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateContactAttributesCommand extends UpdateContactAttributesCommand_base {
