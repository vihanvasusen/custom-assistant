...
declare const TransferContactCommand_base: {
    new (input: TransferContactCommandInput): import("@smithy/smithy-client").CommandImpl<TransferContactCommandInput, TransferContactCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: TransferContactCommandInput): import("@smithy/smithy-client").CommandImpl<TransferContactCommandInput, TransferContactCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class TransferContactCommand extends TransferContactCommand_base {
