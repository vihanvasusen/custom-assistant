...
declare const UpdateUserHierarchyCommand_base: {
    new (input: UpdateUserHierarchyCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUserHierarchyCommandInput, UpdateUserHierarchyCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateUserHierarchyCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUserHierarchyCommandInput, UpdateUserHierarchyCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
