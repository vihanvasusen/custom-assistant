...
declare const ListPhoneNumbersCommand_base: {
    new (input: ListPhoneNumbersCommandInput): import("@smithy/smithy-client").CommandImpl<ListPhoneNumbersCommandInput, ListPhoneNumbersCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListPhoneNumbersCommandInput): import("@smithy/smithy-client").CommandImpl<ListPhoneNumbersCommandInput, ListPhoneNumbersCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
