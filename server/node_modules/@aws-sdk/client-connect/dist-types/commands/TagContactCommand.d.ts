...
declare const TagContactCommand_base: {
    new (input: TagContactCommandInput): import("@smithy/smithy-client").CommandImpl<TagContactCommandInput, TagContactCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: TagContactCommandInput): import("@smithy/smithy-client").CommandImpl<TagContactCommandInput, TagContactCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class TagContactCommand extends TagContactCommand_base {
