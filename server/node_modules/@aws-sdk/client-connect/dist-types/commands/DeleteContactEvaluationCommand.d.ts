...
declare const DeleteContactEvaluationCommand_base: {
    new (input: DeleteContactEvaluationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteContactEvaluationCommandInput, DeleteContactEvaluationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteContactEvaluationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteContactEvaluationCommandInput, DeleteContactEvaluationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
