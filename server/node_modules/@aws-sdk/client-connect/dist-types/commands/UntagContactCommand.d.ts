...
declare const UntagContactCommand_base: {
    new (input: UntagContactCommandInput): import("@smithy/smithy-client").CommandImpl<UntagContactCommandInput, UntagContactCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UntagContactCommandInput): import("@smithy/smithy-client").CommandImpl<UntagContactCommandInput, UntagContactCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UntagContactCommand extends UntagContactCommand_base {
