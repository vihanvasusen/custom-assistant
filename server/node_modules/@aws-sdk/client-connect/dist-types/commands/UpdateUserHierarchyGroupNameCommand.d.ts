...
declare const UpdateUserHierarchyGroupNameCommand_base: {
    new (input: UpdateUserHierarchyGroupNameCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUserHierarchyGroupNameCommandInput, UpdateUserHierarchyGroupNameCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateUserHierarchyGroupNameCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUserHierarchyGroupNameCommandInput, UpdateUserHierarchyGroupNameCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
