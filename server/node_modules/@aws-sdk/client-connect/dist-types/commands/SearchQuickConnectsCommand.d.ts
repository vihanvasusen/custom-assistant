...
declare const SearchQuickConnectsCommand_base: {
    new (input: SearchQuickConnectsCommandInput): import("@smithy/smithy-client").CommandImpl<SearchQuickConnectsCommandInput, SearchQuickConnectsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SearchQuickConnectsCommandInput): import("@smithy/smithy-client").CommandImpl<SearchQuickConnectsCommandInput, SearchQuickConnectsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class SearchQuickConnectsCommand extends SearchQuickConnectsCommand_base {
