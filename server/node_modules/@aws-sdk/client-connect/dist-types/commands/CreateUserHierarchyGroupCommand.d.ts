...
declare const CreateUserHierarchyGroupCommand_base: {
    new (input: CreateUserHierarchyGroupCommandInput): import("@smithy/smithy-client").CommandImpl<CreateUserHierarchyGroupCommandInput, CreateUserHierarchyGroupCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateUserHierarchyGroupCommandInput): import("@smithy/smithy-client").CommandImpl<CreateUserHierarchyGroupCommandInput, CreateUserHierarchyGroupCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
