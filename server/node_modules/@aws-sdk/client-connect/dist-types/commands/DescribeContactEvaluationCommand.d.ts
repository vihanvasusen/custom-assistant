...
declare const DescribeContactEvaluationCommand_base: {
    new (input: DescribeContactEvaluationCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeContactEvaluationCommandInput, DescribeContactEvaluationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeContactEvaluationCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeContactEvaluationCommandInput, DescribeContactEvaluationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
