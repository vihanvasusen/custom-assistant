...
declare const ListEvaluationFormsCommand_base: {
    new (input: ListEvaluationFormsCommandInput): import("@smithy/smithy-client").CommandImpl<ListEvaluationFormsCommandInput, ListEvaluationFormsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListEvaluationFormsCommandInput): import("@smithy/smithy-client").CommandImpl<ListEvaluationFormsCommandInput, ListEvaluationFormsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
