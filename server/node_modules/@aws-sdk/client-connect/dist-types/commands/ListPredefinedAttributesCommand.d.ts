...
declare const ListPredefinedAttributesCommand_base: {
    new (input: ListPredefinedAttributesCommandInput): import("@smithy/smithy-client").CommandImpl<ListPredefinedAttributesCommandInput, ListPredefinedAttributesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListPredefinedAttributesCommandInput): import("@smithy/smithy-client").CommandImpl<ListPredefinedAttributesCommandInput, ListPredefinedAttributesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListPredefinedAttributesCommand extends ListPredefinedAttributesCommand_base {
