...
declare const UpdateTrafficDistributionCommand_base: {
    new (input: UpdateTrafficDistributionCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateTrafficDistributionCommandInput, UpdateTrafficDistributionCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateTrafficDistributionCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateTrafficDistributionCommandInput, UpdateTrafficDistributionCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
