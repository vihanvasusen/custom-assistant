...
declare const StartTaskContactCommand_base: {
    new (input: StartTaskContactCommandInput): import("@smithy/smithy-client").CommandImpl<StartTaskContactCommandInput, StartTaskContactCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartTaskContactCommandInput): import("@smithy/smithy-client").CommandImpl<StartTaskContactCommandInput, StartTaskContactCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartTaskContactCommand extends StartTaskContactCommand_base {
