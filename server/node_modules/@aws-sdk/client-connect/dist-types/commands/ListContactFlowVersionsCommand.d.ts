...
declare const ListContactFlowVersionsCommand_base: {
    new (input: ListContactFlowVersionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListContactFlowVersionsCommandInput, ListContactFlowVersionsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListContactFlowVersionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListContactFlowVersionsCommandInput, ListContactFlowVersionsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
