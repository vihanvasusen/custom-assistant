...
declare const UpdateUserPhoneConfigCommand_base: {
    new (input: UpdateUserPhoneConfigCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUserPhoneConfigCommandInput, UpdateUserPhoneConfigCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateUserPhoneConfigCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUserPhoneConfigCommandInput, UpdateUserPhoneConfigCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
