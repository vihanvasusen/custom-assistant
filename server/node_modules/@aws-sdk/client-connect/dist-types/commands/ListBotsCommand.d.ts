...
declare const ListBotsCommand_base: {
    new (input: ListBotsCommandInput): import("@smithy/smithy-client").CommandImpl<ListBotsCommandInput, ListBotsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListBotsCommandInput): import("@smithy/smithy-client").CommandImpl<ListBotsCommandInput, ListBotsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
