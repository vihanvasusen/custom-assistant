...
declare const SearchSecurityProfilesCommand_base: {
    new (input: SearchSecurityProfilesCommandInput): import("@smithy/smithy-client").CommandImpl<SearchSecurityProfilesCommandInput, SearchSecurityProfilesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SearchSecurityProfilesCommandInput): import("@smithy/smithy-client").CommandImpl<SearchSecurityProfilesCommandInput, SearchSecurityProfilesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class SearchSecurityProfilesCommand extends SearchSecurityProfilesCommand_base {
