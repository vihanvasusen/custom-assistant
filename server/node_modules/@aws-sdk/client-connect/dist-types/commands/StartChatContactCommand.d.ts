...
declare const StartChatContactCommand_base: {
    new (input: StartChatContactCommandInput): import("@smithy/smithy-client").CommandImpl<StartChatContactCommandInput, StartChatContactCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartChatContactCommandInput): import("@smithy/smithy-client").CommandImpl<StartChatContactCommandInput, StartChatContactCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartChatContactCommand extends StartChatContactCommand_base {
