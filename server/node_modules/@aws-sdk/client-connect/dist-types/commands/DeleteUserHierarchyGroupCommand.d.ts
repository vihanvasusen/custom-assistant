...
declare const DeleteUserHierarchyGroupCommand_base: {
    new (input: DeleteUserHierarchyGroupCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteUserHierarchyGroupCommandInput, DeleteUserHierarchyGroupCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteUserHierarchyGroupCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteUserHierarchyGroupCommandInput, DeleteUserHierarchyGroupCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
