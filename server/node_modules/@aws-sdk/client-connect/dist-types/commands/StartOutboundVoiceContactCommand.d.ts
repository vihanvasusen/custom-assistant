...
declare const StartOutboundVoiceContactCommand_base: {
    new (input: StartOutboundVoiceContactCommandInput): import("@smithy/smithy-client").CommandImpl<StartOutboundVoiceContactCommandInput, StartOutboundVoiceContactCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartOutboundVoiceContactCommandInput): import("@smithy/smithy-client").CommandImpl<StartOutboundVoiceContactCommandInput, StartOutboundVoiceContactCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartOutboundVoiceContactCommand extends StartOutboundVoiceContactCommand_base {
