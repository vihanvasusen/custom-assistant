...
declare const ListHoursOfOperationsCommand_base: {
    new (input: ListHoursOfOperationsCommandInput): import("@smithy/smithy-client").CommandImpl<ListHoursOfOperationsCommandInput, ListHoursOfOperationsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListHoursOfOperationsCommandInput): import("@smithy/smithy-client").CommandImpl<ListHoursOfOperationsCommandInput, ListHoursOfOperationsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
