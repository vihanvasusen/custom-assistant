...
declare const DeleteRoutingProfileCommand_base: {
    new (input: DeleteRoutingProfileCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRoutingProfileCommandInput, DeleteRoutingProfileCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteRoutingProfileCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRoutingProfileCommandInput, DeleteRoutingProfileCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
