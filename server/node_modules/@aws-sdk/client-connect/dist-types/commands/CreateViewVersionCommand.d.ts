...
declare const CreateViewVersionCommand_base: {
    new (input: CreateViewVersionCommandInput): import("@smithy/smithy-client").CommandImpl<CreateViewVersionCommandInput, CreateViewVersionCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateViewVersionCommandInput): import("@smithy/smithy-client").CommandImpl<CreateViewVersionCommandInput, CreateViewVersionCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
