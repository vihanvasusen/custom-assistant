...
declare const CreateTrafficDistributionGroupCommand_base: {
    new (input: CreateTrafficDistributionGroupCommandInput): import("@smithy/smithy-client").CommandImpl<CreateTrafficDistributionGroupCommandInput, CreateTrafficDistributionGroupCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateTrafficDistributionGroupCommandInput): import("@smithy/smithy-client").CommandImpl<CreateTrafficDistributionGroupCommandInput, CreateTrafficDistributionGroupCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
