...
import { CreatePersistentContactAssociationRequest, CreatePersistentContactAssociationResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreatePersistentContactAssociationCommand_base: {
    new (input: CreatePersistentContactAssociationCommandInput): import("@smithy/smithy-client").CommandImpl<CreatePersistentContactAssociationCommandInput, CreatePersistentContactAssociationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreatePersistentContactAssociationCommandInput): import("@smithy/smithy-client").CommandImpl<CreatePersistentContactAssociationCommandInput, CreatePersistentContactAssociationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
