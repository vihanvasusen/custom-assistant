...
declare const CreateViewCommand_base: {
    new (input: CreateViewCommandInput): import("@smithy/smithy-client").CommandImpl<CreateViewCommandInput, CreateViewCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateViewCommandInput): import("@smithy/smithy-client").CommandImpl<CreateViewCommandInput, CreateViewCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
