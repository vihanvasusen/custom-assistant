...
declare const StartWebRTCContactCommand_base: {
    new (input: StartWebRTCContactCommandInput): import("@smithy/smithy-client").CommandImpl<StartWebRTCContactCommandInput, StartWebRTCContactCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartWebRTCContactCommandInput): import("@smithy/smithy-client").CommandImpl<StartWebRTCContactCommandInput, StartWebRTCContactCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartWebRTCContactCommand extends StartWebRTCContactCommand_base {
