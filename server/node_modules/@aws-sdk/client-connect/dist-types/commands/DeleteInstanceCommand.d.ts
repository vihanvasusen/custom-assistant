...
declare const DeleteInstanceCommand_base: {
    new (input: DeleteInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteInstanceCommandInput, DeleteInstanceCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteInstanceCommandInput, DeleteInstanceCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
