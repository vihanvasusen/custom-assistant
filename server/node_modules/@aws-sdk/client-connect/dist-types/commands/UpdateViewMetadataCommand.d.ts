...
declare const UpdateViewMetadataCommand_base: {
    new (input: UpdateViewMetadataCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateViewMetadataCommandInput, UpdateViewMetadataCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateViewMetadataCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateViewMetadataCommandInput, UpdateViewMetadataCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
