...
declare const DeleteViewCommand_base: {
    new (input: DeleteViewCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteViewCommandInput, DeleteViewCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteViewCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteViewCommandInput, DeleteViewCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
