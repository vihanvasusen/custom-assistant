...
declare const UpdateUserIdentityInfoCommand_base: {
    new (input: UpdateUserIdentityInfoCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUserIdentityInfoCommandInput, UpdateUserIdentityInfoCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateUserIdentityInfoCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUserIdentityInfoCommandInput, UpdateUserIdentityInfoCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
